...
GeoNode.plugins.Print = Ext.extend(gxp.plugins.Tool, {
     ...
     */
    nonePrintableText: "No Layer can be printed",
...
"gxp.plugins.Print.prototype":{
    ...
    buttonText: "Εκτύπωση",
    notAllNotPrintableText: "Δεν μπορούν να εκτυπωθούν όλα τα επίπεδα",
    nonePrintableText: "Δεν μπορεί να εκτυπωθεί κανένα επίπεδο",
    previewText: "Εκτύπωση Χάρτη"
},

"gxp.plugins.LayerInfo.prototype":{
    menuText: "Μεταδεδομένα Επιπέδου"  
}
});
