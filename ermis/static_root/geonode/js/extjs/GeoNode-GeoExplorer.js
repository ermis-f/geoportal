...
GeoNode.plugins.SaveHyperlink = Ext.extend(gxp.plugins.Tool, {
    ...
    init: function(target) {
        ...
        this.titleTemplate = new Ext.Template("<a class='maplist' href='" +
            this.target.rest + "'>"+this.maps+"</a> / <strong>{title}");
    ...
    getMapTitle: function() {
        ...
        if (this.target.id) {
            ...
            title = this.msg;//"This map is currently unsaved";
        }
...
GeoExt.Lang.add("en", {
     ...
     "GeoNode.plugins.SaveHyperlink.prototype":{
         msg: "This map is currently unsaved",
         maps: "Maps"
  }
...
GeoExt.Lang.add("el", {
    ...
    "GeoNode.plugins.Print.prototype":{
        menuText: "Εκτύπωση Χάρτη",
        tooltip: "Εκτύπωση Χάρτη",
        buttonText: "Εκτύπωση",
        previewText: "Προεπισκόπηση εκτύπωσης",
        nonePrintableText: "Κανένα από τα διαθέσιμα θεματικά επίπεδα δεν μπορεί να εκτυπωθεί",     
        notAllNotPrintableText: "Δεν μπορούν να εκτυπωθούν όλα τα θεματικά επίπεδα"
 },
    "GeoNode.plugins.LayerManager.prototype":{
         baseNodeText: "Υπόβαθρα"     
 },
   "GeoNode.plugins.SaveHyperlink.prototype":{
         msg: "Αυτος ο χάρτης δεν έχει αποθηκευτεί",
         maps: "Χάρτες"
  }
});
